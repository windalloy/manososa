...
export const mapRegions: MapRegion[] = [
  ...
  },
  {
    ...
    x2: 574,
    y2: 157,
    message: '（仓库内部的货架和物品有倒塌和散落迹象，似乎曾发生过剧烈的晃动。空中飞舞着紫色的蝴蝶。地上有一把造型奇特的仪礼剑，剑锋沾有血迹。）',
    bgImage: 'bg/07.avif',
    obtainEvidenceId: '10',
  },
  {
  ...
  },
  {
    ...
    x2: 1001,
    y2: 797,
    message: '（出门后左手边，有一大片花草明显被压倒了，似乎有什么大而沉重的物体曾摆放在这里。旁边还放着一架人字梯，看起来像是从杂物间搬出来的。）',
    bgImage: 'bg/17.avif',
    obtainEvidenceId: '06',
  },
  {
  ...
  },
  {
    ...
    x2: 848,
    y2: 635,
    message: '（离图书室最近的房间。充斥着颜料和...红酒的气味？但是画室里没有任何完成的画作，只有诺亚的素描本摊开放在桌面上。）',
    bgImage: 'bg/31.avif',
    obtainEvidenceId: '07',
  },
  {
  ...
  },
  {
    ...
    x2: 1349,
    y2: 681,
    message: '（整个下午雪莉都被关在这里，直到刚才雪莉才被放出来。目前，玛格的尸体以“自杀”的名义被投票关入惩罚室，这一举动旨在让全体成员都能参与调查，但同时我也失去了对玛格尸体进一步调查的可能。）',
    bgImage: 'bg/27.avif',
  },
  {
    name: '焚烧炉',
    ...
    x2: 706,
    y2: 627,
    message: '（焚烧炉内发现大量樱花花瓣，其新鲜度与上午雪莉造成的樱花雨吻合。一件明显属于艾玛的衣物落在花瓣上面，可推断衣物是在花瓣被倒入后才被扔进来的。）',
    bgImage: 'bg/24.avif',
    obtainEvidenceId: '03',
  },
  // 楼层切换区域（map_1）
