...
export const initialEvidence: Evidence[] = [
  ...
  },
  {
    id: '11',
    name: '艾玛的证言',
    description: '根据艾玛的回忆，她下午长时间待在玄关大厅，并记录了特定时间段内人员的进出情况：14:15 蕾雅持花环进入。14:30 梅露露空手离开。14:40 汉娜与米莉亚空手离开。15:00-15:10 米莉亚两次单独进出。15:30 亚里沙持药瓶离开。15:40 梅露露返回建筑。',
    image: '11.png',
    obtained: false,
  },
  {
  ...
  },
  {
    id: '13',
    name: '可可的证言',
    description: '泽渡可可声称，她下午通过直播的“俯瞰”能力，确认了多位少女在特定时间点的所在位置。13:30-14:40，安安和诺亚一直在画室。13:00-14:40，蕾雅、亚里沙和米莉亚在娱乐室（蕾雅曾短暂离开）。13:30-14:10，奈叶香一直在火精之室。',
    image: '13.png',
    obtained: false,
  },
  {
