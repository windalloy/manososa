 ...
 * 功能：
 * - 在游戏开始时显示欢迎信息和游戏说明
 * - 介绍玩家角色（Detective Sheerluck）和游戏目标
 * - 说明如何与角色对话、调查地点、出示证物
 * - 提示游戏结束后的推理环节
 * - 提供学习更多信息的链接
 */
...
const IntroModal: React.FC<IntroModalProps> = ({ opened, onClose }) => {
  ...
  return (
    <>
      ...
      今天下午四点，泽渡可可、城崎诺亚和夏目安安发现了宝生玛格的尸体。她倒在图书室内部，背后插着莲见蕾雅的刺剑。尸体旁边，掉落着黑部奈叶香的发带，上面沾有血迹。图书室中央的樱树上插着一根弩箭，箭尾指向图书室门口。本应在玄关大厅的扫帚不知为何出现在樱树旁边。根据冰上梅露露的判断，玛格的死亡时间大约是下午三点，尸体有被刺伤和砸伤的痕迹，尚不明确真正的死因。图书室内部和门口均有一些红蝴蝶在飞舞。
      </Text>
      <br></br>
      <Text style={{ 
        color: 'rgba(220, 220, 220, 1)', 
