  ...
  return (
    <>
      ...
      <style>{`
        ...
        .help-modal-scroll-area {
          scrollbar-width: thin !important; /* Firefox */
          scrollbar-color: rgba(0, 0, 0, 0.8) transparent !important; /* Firefox */
        }
        .help-modal-scroll-area *::-webkit-scrollbar {
          width: ${3 * scale}px !important; /* 非常小的滚动条宽度 */
        }
        .help-modal-scroll-area *::-webkit-scrollbar-track {
          background: transparent !important;
        }
        .help-modal-scroll-area *::-webkit-scrollbar-thumb {
          background-color: rgba(0, 0, 0, 0.8) !important;
          border-radius: ${1.5 * scale}px !important;
          border: none !important;
        }
        .help-modal-scroll-area *::-webkit-scrollbar-thumb:hover {
      ...
      >
        <ScrollArea 
          className="help-modal-scroll-area"
          style={{ 
            flex: '1 1 auto',
            minHeight: 0,
        ...
        >
          ...
          {currentPage === 3 && (
            <Text style={{ 
              ...
              <br></br><br></br>
              {highlightQuotedWords('如果你发现出示一个证物后，角色的表情发生改变，但没有追加证言，说明你需要先向该角色出示其它证物以解锁"前置证言"。', ['前置证言'])}
              <br></br><br></br>
